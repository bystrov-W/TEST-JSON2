...
<?php if ((!isset($_POST['submitBtn'])) || ($error != '')) {?>
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="registerform">
        <table width="100%">
          <tr><td>Новый Пользователь:</td><td> <input class="text" name="username" type="text"  /></td></tr>
          <tr><td>Пароль:</td><td> <input class="text" name="password1" type="password" /></td></tr>
          <tr><td>Подтвердите пароль:</td><td> <input class="text" name="password2" type="password" /></td></tr>
